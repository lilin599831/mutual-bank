export const STAKE_ABI = [
  'function userTotalStaked(address user) view returns (uint256)',
  'function referrer(address user) view returns (address)',
  'function totalReferred(address user) view returns (uint256)',
  'function currentStakingRate(address user) view returns (uint256)',
  'function currentReferralRate(address user) view returns (uint256)',
  'function totalRewards(address user) view returns (uint256)',
  'function stake(uint256 amount, address referrer)',
  'function unstake(uint256 amount)',
  'function claimRewards()',
  'function getStakes(address user) view returns (tuple(uint256 amount, uint256 startTime, uint256 rate)[])'
];
...
export const MUTUAL_BANK_ABI = [
    ...
    },
    {
        ...
        "outputs": [
            ...
            {
                "internalType": "uint256",
                "name": "stakingConfigCount",
                "type": "uint256"
            },
            {
                "internalType": "uint256",
                "name": "referralConfigCount",
                "type": "uint256"
            }
        ],
        ...
        "inputs": [
            {
                ...
                "internalType": "struct MutualBank.RateConfig[]",
                "name": "newRates",
                "type": "tuple[]"
            }
        ],
